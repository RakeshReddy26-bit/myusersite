      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          <div className="flex items-center gap-3 mb-4">
            <div className="bg-white text-black font-bold rounded-lg w-9 h-9 flex items-center justify-center text-lg shadow">R</div>
            <span className="text-xl font-extrabold tracking-wide">REWASH</span>
          </div>
