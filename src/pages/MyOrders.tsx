  ...
  if (authLoading || loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh]">
        ...
        <div className="text-lg text-gray-600 dark:text-gray-300">Loading your orders...</div>
      </div>
    );
  }
  ...
  if (!orders.length) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh]">
        ...
        <a href="/add-clothes" className="px-6 py-3 bg-primary-600 text-white rounded-xl font-semibold shadow hover:bg-primary-700 transition text-lg">Create Order</a>
      </div>
    );
  }
